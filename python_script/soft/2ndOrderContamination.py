...
if __name__ == "__main__":
    ...
    value, keys = tb.readlist(file, ('pixel', 'w', 'aper_flux', 'psf_gauss_flux', 'psf_gauss_sigma',
                                     'psf_gauss_mu', 'psf_voigt_flux', 'psf_voigt_fwhmL', 'psf_voigt_fwhmG'))
    ...
    pl.legend()
    tb.DumpTuple(('wavelength', 'contamination'), (second[:, 0], second[:, 1]/interp), outfile)
