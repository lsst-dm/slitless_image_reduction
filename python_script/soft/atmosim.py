...
Atm = ['lt'] # trying this one : pression is closer to CTIO
...
#   Selection of absorption model
    ...
    for atmosphere in theatmospheres:
        ...
        BaseFilename = BaseFilename_part1+atmkey+'_'+Proc+'_'+Mod+'_z' + \
            str(amfileindex)+'_'+WVXX+str(wvfileindex) + '_'+OZXX+str(ozfileindex)
        ...
        uvspec.inp["output_quantity"] = 'transmittance'#'reflectivity'
#        uvspec.inp["verbose"] = ''
        uvspec.inp["quiet"] = ''
