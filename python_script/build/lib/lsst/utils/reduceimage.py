...
class Process(object):
    ...
    def SetFootprint(self, x_object, y_object,
        ...
        if (self.orientation== 'x'):
            x_start = x_object + translate_x ; x_end = x_start+extend;    #''' footprint'''
            y_start = y_object - half_width  ; y_end = y_object+half_width;#''' footprint'''
        elif(self.orientation == 'y'):
            x_start = x_object - half_width  ; x_end = x_object+half_width ;#''' footprint'''
            y_start = y_object + transalte_y ; y_end = y_start+extend;     #''' footprint'''
