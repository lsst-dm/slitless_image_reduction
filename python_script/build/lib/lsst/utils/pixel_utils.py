...
class Rxx_flat(object):
    def __init__(self, nsig, bordersize, minpixcount
                 , biassec = '[531:536,29:1800]'
                 , datasec = '[37:510,19:1970]'
                 , device  = "LSST"
                 , exptime_name = "0"
                 ,**kwargs):
        # mask parameters 
    ...
    def correct_Sec_Subaru(self, extheader):
        ...
        illu  = self.DATASEC
        b = "'["
        for char in b: illu=illu.replace(char,"")
    ...
    def local_copy_and_modif_chan_header(self, data_dir, refname, chan
                                        , method = "ImageCopy", **kwargs):
